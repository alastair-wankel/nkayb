...
<html lang="en">
  <head>
    ...
    background: -webkit-linear-gradient(white, #86c67c); /* For Safari 5.1 to 6.0 */
    background: -o-linear-gradient(white, #86c67c); /* For Opera 11.1 to 12.0 */
    background: -moz-linear-gradient(white, #86c67c); /* For Firefox 3.6 to 15 */
    background: linear-gradient(white, #86c67c); !important/* Standard syntax (must be last) */
          }     
    </style>
  </head>
